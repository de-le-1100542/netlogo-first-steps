...
to setup-weather-scenario
  ...
  set soil-patches patches with [ shade-of? pcolor soil-brown ]
   ...
   [ ask water-patches [ set level-change level-change * 2 ] ]              ; if the weather is wet and warm, the water level changes at a standard rate
...
to setup-toads
  ...
  [
    ...
    [
      ...
      set speed 2
      set color grey
    create-link-to one-of toads                              ; creates link to one-of male toads
    set my-day-of-hatching one-of ( list 106 116 126 136 )
    ]
end
...
; to the midth of July until the midth of September and the water body still
; carries at least 10 cm of water (5 x-coordinates), the females that have       ;;; TO DO: day-of-reproduction ( (.... >= 106 and day-of-reproduction <= 160 ) ) ... Idee: Liste
; mated before hatch young toads.                                                ;;; jede female toad hatched ein mal in dem Zeitraum random zwischen 1 und 5 Kröten
  ask female-toads
  [
    move-until
  ...
  ask plants [ set energy energy - 1 ]
...
to move-until
  ...
  [ let target one-of link-neighbors
   ; set heading [ nw:turtles-on-path-to [ new-location ] of myself ] of current-location
    face target
    move-to target
...
to grow-plants
  ...
  [
    hatch random-exponential 3                   ; every new plant reproduces exponentially, ...
    [
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="initial-number-of-toads">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="weather-scenario">
      <value value="&quot;dry-and-warm&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="extensive-grazing?">
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
